if script_key then
    ...
    getgenv().Setting = {
        ...
        ["Webhook"] = {
            ["Url"] = "https://discord.com/api/webhooks/1198301213356195870/gZmc9NxeAeJdmHOUNVJykKXxlpX2-YcOGlfO4fsyqnACEa0cr-kAwOsfdIi7elatYNHh",
            ["Enabled"] = true,
            ["Embed"] = true,
            ["StoredFruit"] = true,
            ["ImageEmbed"] = true,
            ["CustomImage"] = true,
            ["CustomImageUrl"] = "https://cdn.discordapp.com/attachments/1198301185711550516/1198527155265613884/7e1ed977a07e5507dadc38da1e4ad9152.png?ex=65bf3a65&is=65acc565&hm=7c299906642ed69d041418551e617fd41a4d161bb443ac3148b60103193046fe&", --Your Url
            ["OnServerHop"] = true,
            ["BountyChanged"] = true,
        }, 
        ["Panel"] = true,
        ...
        ["Detect KeyWords"] = { -- If There Is A Person Says A Key Word In Chat, It Will Stop Auto Bounty And  Server Hop
            Enable = true,
            Words = { "Hacker", "Exploiter", "Scripter", "Script", "Hack", "W-Azure", "hacker", "scripter", "hack", "exploit", "hile", "Hile", "hacking", "Hacking", "scripting", "Scripting"}
        },
        ...
        ["Mention"] = {
            ["Enable"] = true,
            ["Id"] = "432635572255981578", -- You Can Replace With Your Id (not your discord Name)
            ["EveryBounty"] = 7000,
        },
        ["FpsLock"] = {
            ["Enable"] = true,
        ...
        ["GunMethodSetting"] = {
            ...
            StartHealth = 1500, -- Below Is Setting For Decrease Sus Kill From Gun Method
            waittime=4,
            EndHealth = 2000,
        },
        ["Notify"] = {
